...
int main(int argc, char* argv[]) {
    ...
    Def defs[] = {
        ...
        { XK_3,     20, "Ctrl+Shift+3 → 15%" },
        { XK_4,     25, "Ctrl+Shift+4 → 20%" },
        { XK_5,     30, "Ctrl+Shift+5 → 25%" },
        { XK_6,     35, "Ctrl+Shift+6 → 30%" },
        { XK_7,     40, "Ctrl+Shift+7 → 35%" },
        { XK_8,     45, "Ctrl+Shift+8 → 40%" },
        { XK_9,     50, "Ctrl+Shift+9 → 45%" },
